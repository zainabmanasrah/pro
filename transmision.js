...
height:190,marginRight:100}}>
     ...
     <Text style={TransmissionStyle.Text}> الحساب  المرحل أو المودع اليه</Text>
 <TextInput style={TransmissionStyle.input} placeholder='حساب الزبون   ' />
 
 <Text style={TransmissionStyle.Text}>   المبلغ المراد ترحيله أو إيداعه   </Text>
 <TextInput style={TransmissionStyle.input} placeholder=' ####### ' />
 

 <View style={TransmissionStyle.buttons}>
 <TouchableOpacity style={{backgroundColor:"#9A4726", paddingVertical:10,marginTop:20,width:130,height:45,marginLeft:30,borderRadius:20}} onPress={handleclick}>
<Text style={{textAlign:'center',color:"white",justifyContent:"space-around",fontSize:20}} >تأكيد</Text>
</TouchableOpacity>
<TouchableOpacity onPressIn={callFun2} style={{backgroundColor:"#FDE9D9", paddingVertical:10,marginTop:20,width:130,height:45,marginLeft:60,borderRadius:20}} onPress={handleclick}>
